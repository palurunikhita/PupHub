...
<%
    ...
    try{
        ...
        File image=new File("C:\\PUP HUB\\IMG\\Products\\"+c);
        PreparedStatement ps =con.prepareStatement("insert into productsandaccessories (productsname, ptype, dogtype, size, productimage) values (?,?,?,?,?) ");
        ...
        if(i == 1)
        {        
            response.sendRedirect("Products.jsp?success");            
        }
        else{
