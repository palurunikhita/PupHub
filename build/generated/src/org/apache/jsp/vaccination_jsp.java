...
public final class vaccination_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <br>\n");
      out.write("        <div>\n");
      out.write("            <h2>Location Search</h2>\n");
      out.write("        </div>\n");
      out.write("        <br>\n");
      out.write("        <br>\n");
      out.write("        <h2>Select Location</h2>\n");
      out.write("        <script>\n");
      out.write("                function valid(){\n");
      out.write("                 var  dage = document.form.dage.value;\n");
      out.write("                    if(dage == 0)\n");
      out.write("                    {\n");
      out.write("                            alert(\"select one option\");\n");
      out.write("                            document.form.dage.focus();\n");
      out.write("                            return false;\n");
      out.write("                    }\n");
      out.write("                    var  Vname = document.form.Vname.value;\n");
      out.write("                    if(Vname == 0)\n");
      out.write("                    {\n");
      out.write("                            alert(\"enter vaccination name\");\n");
      out.write("                            document.form.Vname.focus();\n");
      out.write("                            return false;\n");
      out.write("                    }\n");
      out.write("                    \n");
      out.write("                }\n");
      out.write("            </script>            \n");
      out.write("            <form action=\"vaccinationDB.jsp\" method=\"post\" name=\"form\" onsubmit=\"return valid()\">\n");
      out.write("            <select name=\"dage\">\n");
      out.write("                            <option selected disabled>Dog AGE</option>\n");
      out.write("                            <option value=\"11-13 WEEKS\">11-13 WEEKS</option>\n");
      out.write("                            <option value=\"15-17 WEEKS\">15-17 WEEKS</option>\n");
      out.write("                            <option value=\"15 MONTHS\">15 MONTHS</option>\n");
      out.write("                            <option value=\"ANNUALLY\">ANNUALLY</option>\n");
      out.write("            </select>\n");
      out.write("            <input type=\"text\" placeholder=\"Enter vaccination name\" name=\"Vname\" pattern=\"[A-Za-z]+\" title=\"please enter character in between A-Z or a-z\"  autocomplete=\"off\">\n");
      out.write("            <br>\n");
