...
<div><label class="heading">Food Details</label></div>
<br>
<%
    Connection con = null;
    ...
    try{  
          ...
          PreparedStatement ps =con.prepareStatement("select * from foodtimings where dogtype= ?");
          ps.setString(1, dogtype);
          ResultSet rs = ps.executeQuery();
          
 %> 
        <TABLE cellpadding="15" border="1" style="background-color:#F8F5F1; margin-bottom: 180px; margin-top: 10px;">
            <tr>
                <th>Breed</th>
                <th>Age</th>
