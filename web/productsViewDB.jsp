...
<li><a href="ProductsandAccessoriesdetails.jsp" class="active">Products</a></li>
...
<%@page import="java.sql.PreparedStatement"%>
<%@page import="java.sql.Connection"%>
<div><label class="heading">Products Details</label></div>
<br>
<%
    Connection con = null;
    Blob image = null;
    ...
    try{  
          ...
          PreparedStatement ps =con.prepareStatement("select * from productsandaccessories where dogtype=?"); 
        ...
        <TABLE cellpadding="15" style="background-color: #F8F5F1;">
            <tr>
             ...
             <tr>
                 ...
                 <td height="150"><div align="center"> <input  name="image" type="image" src="product_Pic.jsp?id=<%=i%>" style="width:140px; height:140px;" />
              </div></td>
