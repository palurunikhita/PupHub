...
<li><a href="index.jsp">Logout</a></li>
    ...
    <div class="form-div animated flip">
        ...
        <form action="productsViewDB.jsp" method="post" name="form" onsubmit="return valid()">
            <%
    Connection con = null;
    try{  
          con = DBCon.DbConnector.getConnection();        
         PreparedStatement ps =con.prepareStatement("select DISTINCT(dogtype) from productsandaccessories");
